...
AlphaT::AlphaT(const std::string & name, 
...
TSimpleArray<TRootJet> AlphaT::SubArrayGoodJets(const TClonesArray *JET, const float & pt, const float & eta) {
...
TSimpleArray<TRootElectron> AlphaT::SubArrayEl(const TClonesArray *ELEC, const float & pt, const float & eta) {
...
TSimpleArray<TRootMuon> AlphaT::SubArrayMu(const TClonesArray *MUON, const float & pt, const float & eta) {
...
TSimpleArray<TRootJet> AlphaT::SubArrayBadJets(const TClonesArray *JET, const float & pt, const float & eta) {
...
TSimpleArray<TRootETmis> AlphaT::makeETM(const TClonesArray *ETMISS) {
...
void AlphaT::Run(const TreeReader & treereader, const TreeReader & gentreereader, const double & weight) {
