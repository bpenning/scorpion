...
TSimpleArray<TRootJet> AlphaTb::SubArrayGoodJets(const TClonesArray *JET, const float & pt, const float & eta) {
...
TSimpleArray<TRootElectron> AlphaTb::SubArrayEl(const TClonesArray *ELEC, const float & pt, const float & eta) {
...
TSimpleArray<TRootMuon> AlphaTb::SubArrayMu(const TClonesArray *MUON, const float & pt, const float & eta) {
...
TSimpleArray<TRootJet> AlphaTb::SubArrayBadJets(const TClonesArray *JET, const float & pt, const float & eta) {
...
TSimpleArray<TRootETmis> AlphaTb::makeETM(const TClonesArray *ETMISS) {
...
void AlphaTb::Run(const TreeReader & treereader, const TreeReader & gentreereader, const double & weight) {
