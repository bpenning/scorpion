...
AlphaT20bValid::AlphaT20bValid(const std::string & name, 
  ...
  AlphaT20bValid::AlphaT20bValid(const std::string & name, 
	...
	const bool & calculateR) :
      ...
      AlphaT20bValid::~AlphaT20bValid() {}



      void AlphaT20bValid::initHistos() {
	andir->cd();
...
void AlphaT20bValid::Run(const Reader * treereader, const Reader * gentreereader, const double & weight) {
