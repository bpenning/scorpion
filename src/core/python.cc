...
BOOST_PYTHON_MODULE(libjad_DelphesAnalysis)
{
	...
	.def(init<
		...
		>());
    ;
    class_<AlphaT20bValid, bases<AnalysisBase> >("AlphaT20bValid", init<const std::string &, const std::string &, const unsigned int &>())
	.def(init<
		const std::string &, 
		const std::string &, 
		const unsigned int &, 
	...
	.def(init<
		...
		>());
    ;
    class_<Hinv20b, bases<AnalysisBase> >("Hinv20b", init<const std::string &, const std::string &, const unsigned int &>())
	.def(init<
		const std::string &, 
		const std::string &, 
		const unsigned int &, 
	...
	.def(init<
		...
		>());
    ;
    class_<Alphat13T, bases<AnalysisBase> >("Alphat13T", init<const std::string &, const std::string &, const unsigned int &>())
	.def(init<
		const std::string &, 
		const std::string &, 
		const unsigned int &, 
	...
	.def(init<
		...
		>());
    ;
    class_<MonoJet8ss, bases<AnalysisBase> >("MonoJet8ss", init<const std::string &, const std::string &, const unsigned int &>())
	.def(init<
		const std::string &, 
		const std::string &, 
		const unsigned int &, 
