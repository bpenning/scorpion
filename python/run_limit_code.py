...
def runlim(outdir,filemap_dict,com,gen_info,ss5b=0,os5b=0,lp5b=0,alphat7b=0,alphat7bb=0,alphat12b=0,ss11b=0,alphat40b=0,ss40b=0):
...
#ss8_11b = j.SSb8('SSb8_analysis11','CMS8', 1, 10.5, bg_ssb8, bgunc_ssb8, data_ssb8, 'combined', calculateRno)
    ...
    monojet8 = j.MonoJet8('MonoJet_analysis8','CMS8', 7, 19.5, bg_monojet8, bgunc_monojet8, data_monojet8, 'individual', calculateRno)
# for extrapolations:
